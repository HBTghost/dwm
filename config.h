...
static char selbordercolor[]        = "#0094D0";
static char selbgcolor[]            = "#003c54";
...
const char *spcmd1[] = {ST, "-n", "spterm", "-f", "Fira Code:size=10", "-g", "120x34", NULL};
const char *spcmd2[] = {ST, "-n", "spcalc", "-f", "Fira Code:size=16", "-g", "50x20", "-e", "bc", "-lq", NULL };
